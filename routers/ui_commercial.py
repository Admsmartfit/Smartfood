...
def purchasing(request: Request, _=AdminOrChef):
...
def orders(request: Request, db: Session = Depends(get_db), _=AdminOrChef):
...
def b2b_intelligence(request: Request, db: Session = Depends(get_db), _=AdminOrChef):
...
def suppliers(request: Request, db: Session = Depends(get_db), _=AdminOrChef):
...
def dre(request: Request, db: Session = Depends(get_db), _=AdminOnly):
...
def financial(request: Request, db: Session = Depends(get_db), _=AdminOnly):
